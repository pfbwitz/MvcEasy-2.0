...
<html lang="en">
  ...
  <body class="app flex-row align-items-center">
    ...
    <script src="script/vendors/jquery/js/jquery.min.js"></script>
    <script src="script/vendors/popper.js/js/popper.min.js"></script>
    <script src="script/vendors/bootstrap/js/bootstrap.min.js"></script>
    <script src="script/vendors/pace-progress/js/pace.min.js"></script>
    <script src="script/vendors/perfect-scrollbar/js/perfect-scrollbar.min.js"></script>
    <script src="script/vendors/@coreui/coreui/js/coreui.min.js"></script>
  </body>
</html>